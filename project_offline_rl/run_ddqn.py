...
def run_ddqn(learning_rate, gamma, target_update_interval, batch_size, graph=False, visible=False):
    ...
    name = 'DDQN_marioai_%s_%s_%s_%s_%s_%s' % (
...
if __name__ == '__main__':
    run_ddqn(training_params.learning_rate, training_params.gamma, training_params.target_update_interval,
